...
function createScheduledSoundTouchNode(audioCtx, audioBuffer, onInitialized = null) {
    class ScheduledSoundTouchNode extends AudioWorkletNode {
        ...
        get pitch() {
            var _a;
            return (_a = this.parameters.get("pitch")) === null || _a === void 0 ? void 0 : _a.value;
        }
        /**
        ...
        get pitchSemitones() {
            var _a;
            return (_a = this.parameters.get("pitchSemitones")) === null || _a === void 0 ? void 0 : _a.value;
        }
        /**
        ...
        get rate() {
            var _a;
            return (_a = this.parameters.get("rate")) === null || _a === void 0 ? void 0 : _a.value;
        }
        /**
        ...
        get tempo() {
            var _a;
            return (_a = this.parameters.get("tempo")) === null || _a === void 0 ? void 0 : _a.value;
        }
        /**
